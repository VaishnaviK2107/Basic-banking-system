...
<html lang="en">
 <head>
    ...
    <title>Pune Bank | Transfer Money</title>
 ...
 <body>
    <div class="containe">
        ...
        <div class="navigatio">
            <div class="logo">
                ...
                Bank<span class="logo-hlt">Pune</span> Bank
            </div>
            <nav>
                <ul>
                    <li>
    ...
    <footer id="footer">
        <p>&copy; Copyright 2023 <span class="footer_logo">Pune Bank</span></p>
        <div class="social-icon">
                
                <a href="mailto: adatkarpratiksha14@gmail.com"><i class="fas fa-envelope"></i></i></a>
